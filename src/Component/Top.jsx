...
const Top = () => {
  return (
    <div className="w-full flex justify-between gap-5 items-center bg-green-400 text-white  sm:px-10 ">
      ...
      <div className="h-full pr-8">
        <button className="text-sm font-medium bg-[#089549] md:px-9 md:py-3 p-1 uppercase">
          Join us now
        </button>
      </div>
    </div>
